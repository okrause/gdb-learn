...
/*
 * crash_roster.c — GDB follow-up: SIGSEGV and core dumps.
 *
 * Build:
 *   gcc -g -O0 -o crash_roster crash_roster.c
 *
 * Run:
 *   ./crash_roster            # NULL deref: lookup id 999 (segfault)
 *   ./crash_roster 103        # succeeds (Grace)
 *   ./crash_roster uaf        # use-after-free, then deref
 *
 * Do not ship a core file. Generate one yourself on Linux; see 02-crash-core.md.
 */
